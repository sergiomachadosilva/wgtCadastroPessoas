<!-- Modelo Mustache para o modal de cadastro-->
<script id="tpl_formModalNew" type="text/template">
	<fieldset>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="form-group fs-lg-margin-top">
					...
					<input type="hidden" name="atividadeRemunerada" id="atividadeRemunerada" />
					<input type="checkbox" id="atividadeRemuneradaOpt" data-size="small" data-on-color="success" data-off-color="danger" data-on-text="Sim" data-off-text="Não">
				</div>
			</div>
		</div>
	</fieldset>
	...
	<fieldset>
		...
		<div class="row">
			<div class="col-md-12">
				<table class="table" id="tableEnderecos">
	                ...
	                <tbody>
	                    <tr style="display:none">
	                        ...
	                        <td  class="fs-v-align-middle">
		                        <div class="form-group fs-no-margin-bottom">
		                            <input type="text" class="form-control input-sm" name="endereco" readonly="readonly"/>
		                        </div>
	                        </td>
	                         <td  class="fs-v-align-middle">
		                        <div class="form-group fs-no-margin-bottom">
	                        ...
	                        <td  class="fs-v-align-middle">
		                        <div class="form-group fs-no-margin-bottom">
		                            <input type="text" class="form-control input-sm" name="bairro" readonly="readonly"/>
		                        </div>
	                        </td>
	                        <td  class="fs-v-align-middle">
		                        <div class="form-group fs-no-margin-bottom">
			    ...
			    <button type="button" class="btn btn-sm btn-success fs-xs-margin-bottom btn-addRow" data-addRowEnd="" title="Adicionar Novo Endereço">
